...
import org.easydarwin.easyplayer.databinding.ActivityPlayRtmpBinding;
 ...
 * 播放页
 * */
public class PlayRTMPActivity extends AppCompatActivity implements PlayRTMPFragment.OnDoubleTapListener {

    private static final int MY_PERMISSIONS_REQUEST_WRITE_EXTERNAL_STORAGE = 0x111;

    private PlayRTMPFragment mRenderFragment;
...
//    private float mMaxVolume;
    ...
    private ActivityPlayRtmpBinding mBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            if (rr == null) {
                rr = new ResultReceiver(new Handler()) {
                    ...
                    protected void onReceiveResult(int resultCode, Bundle resultData) {
                        ...
                        if (resultCode == PlayRTMPFragment.RESULT_REND_START) {
                            onPlayStart();
                        } else if (resultCode == PlayRTMPFragment.RESULT_REND_STOP) {
                            onPlayStop();
                        } else if (resultCode == PlayRTMPFragment.RESULT_REND_VIDEO_DISPLAY) {
                            onVideoDisplayed();
                        }
                    }
                };
            ...
            PlayRTMPFragment fragment = PlayRTMPFragment.newInstance(url, useUDP ? RTMPClient.TRANS_TYPE_UDP : RTMPClient.TRANS_TYPE_TCP, rr);
            ...
            mRenderFragment = (PlayRTMPFragment) getSupportFragmentManager().findFragmentById(R.id.render_holder);
        }

        mBinding = DataBindingUtil.setContentView(this, R.layout.activity_play_rtmp);
        ...
        if (ActivityCompat.shouldShowRequestPermissionRationale(this, Manifest.permission.WRITE_EXTERNAL_STORAGE)) {
            ...
            new AlertDialog.Builder(this).setMessage(toTakePicture ? "EasyPlayer需要使用写文件权限来抓拍" : "EasyPlayer需要使用写文件权限来录像").setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialogInterface, int i) {
                    ActivityCompat.requestPermissions(PlayRTMPActivity.this,
...
//        startActivity(intent);
     ...
     * */
    public void onEvent(PlayRTMPFragment playRTMPFragment, int state, int err, String msg) {
        mBinding.msgTxt.append(String.format("[%s]\t%s\t\n",
...
//        new AlertDialog.Builder(PlayRTMPActivity.this).setTitle("新的播放窗口").setItems(new CharSequence[]{"选取历史播放记录", "手动输入视频源"}, new DialogInterface.OnClickListener() {
//            @Override
...
//
//                    if (array.length == 0) {
//                        Toast.makeText(PlayRTMPActivity.this, "没有历史播放记录", Toast.LENGTH_SHORT).show();
//                        return;
//                    }
//
...
//                    }
//
//                    new AlertDialog.Builder(PlayRTMPActivity.this).setTitle("新的播放窗口").setItems(array, new DialogInterface.OnClickListener() {
//                        @Override
//                        public void onClick(DialogInterface dialog, int which) {
...
//                } else {
//                    final EditText edit = new EditText(PlayRTMPActivity.this);
...
//
//                    final AlertDialog dlg = new AlertDialog.Builder(PlayRTMPActivity.this).setView(edit).setTitle("请输入播放地址").setPositiveButton("确定", new DialogInterface.OnClickListener() {
//                        @Override
//                        public void onClick(DialogInterface dialogInterface, int i) {
...
//        final FrameLayout item = new FrameLayout(PlayRTMPActivity.this);
...
//        boolean useUDP = SPUtil.getUDPMode(this);
//        getSupportFragmentManager().beginTransaction().add(item.getId(), PlayRTMPFragment.newInstance(url, useUDP ? RTMPClient.TRANS_TYPE_UDP : RTMPClient.TRANS_TYPE_TCP, null)).commit();
//    }
//
//    /**
//     * 删除一个播放窗口
